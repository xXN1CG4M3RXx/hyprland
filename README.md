...
/config/ -> Subfolder of different configs (for cleaner structure) <br>
    ...
    /config/binds.lua -> all keybinds are set here <br>
    /config/colors.lua -> color theme definitions <br>
    /config/decorations.lua -> basic decoration settings <br>
    /config/environment.lua -> main environment settings <br>
    /config/inputs.lua -> touchpad configuration (laptop) <br>
    /config/misc.lua -> miscellanious settings <br>
    /config/monitors.lua -> monitor settings (layout, resolution, refreshrate etc.) <br>
