...
hl.workspace_rule({ workspace = "4", monitor = LAPTOPMONITOR, default = true, persistent = true})
hl.workspace_rule({ workspace = "5", monitor = LAPTOPMONITOR, default = true, persistent = true})
hl.workspace_rule({ workspace = "6", monitor = LAPTOPMONITOR, default = true, persistent = true})
